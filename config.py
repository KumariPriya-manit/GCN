...
glimpse_arg.add_argument(
    "--patch_size", type=int, default=200, help="size of extracted patch at highest res"
)
glimpse_arg.add_argument(
...
glimpse_arg.add_argument(
    "--loc_hidden", type=int, default=glimpse_hidden_size, help="hidden size of loc fc"
)
glimpse_arg.add_argument(
    "--glimpse_hidden", type=int, default=glimpse_hidden_size, help="hidden size of glimpse fc"
)
...
data_arg.add_argument(
    "--batch_size", type=int, default=b_size, help="# of images in each batch of data"
)
data_arg.add_argument(
    "--num_workers",
    type=int,
...
train_arg.add_argument(
    "--epochs", type=int, default=1, help="# of epochs to train for"
)
train_arg.add_argument(
...
misc_arg.add_argument(
    "--data_dir", type=str, default="./data/handwritten", help="Directory in which data is stored"
)
misc_arg.add_argument(
    "--ckpt_dir",
    type=str,
